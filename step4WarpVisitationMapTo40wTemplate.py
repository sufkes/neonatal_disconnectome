...
from constants import TEMPLATE_TEMPLATES_DIR, RUNS_DIR, CONTROLS_DIR

def warpVisitationMap(subject, image_type):
  ...
  for d in dir_list:
    ...
    # moving path
    controls_path = runs_control_space_path / sub_name
    ...
    try:
      new_dir = runs_visitation_maps_40w_path / sub_name
